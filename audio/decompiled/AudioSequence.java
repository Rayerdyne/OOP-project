...
public class AudioSequence
{
    ...
    public AudioSequence(final String pathname) throws AudioSequenceException {
        try {
            ...
            if (n > 2147483647L) {
                throw new AudioSequenceException(invokedynamic(
makeConcatWithConstants:(Ljava/lang/String;)Ljava/lang/String;, 
"Your audio file is too large and amounts more than "));
            }
            ...
            throw new AudioSequenceException(
    ...
    public void output(final String pathname) throws AudioSequenceException {
        try {
            ...
            AudioSystem.write(
                new AudioInputStream(new ByteArrayInputStream(buf), 
                this.format, this.leftChannel.length),
                AudioFileFormat.Type.WAVE, new File(pathname));
        }
        catch (IOException ex) {
            throw new AudioSequenceException(invokedynamic(
makeConcatWithConstants:(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;,
"An I/O error occurred while writing the output file: ", ex.getMessage()));
        }
    }
}
